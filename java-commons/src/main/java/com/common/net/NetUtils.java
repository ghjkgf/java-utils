...
import com.common.collection.LRUCache;
...
public class NetUtils {
    ...
    private static final Map<String, String> hostNameCache = new LRUCache<>(100);
    ...
    private static class CIDRUtils {
        ...
        CIDRUtils(String cidr) throws UnknownHostException {
