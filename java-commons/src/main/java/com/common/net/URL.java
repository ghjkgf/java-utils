...
public final class URL implements Serializable {
    ...
    public URL(String protocol, String host, int port, String[] pairs) { // varargs ... conflict with the following path argument, use array instead.
        this(protocol, null, null, host, port, null, Commons.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String host, int port, String path, String... pairs) {
        this(protocol, null, null, host, port, path, Commons.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String username, String password, String host, int port, String path, String... pairs) {
        this(protocol, username, password, host, port, path, Commons.toStringMap(pairs));
    }

    public URL(String protocol, String username, String password, String host, int port, String path, Map<String, String> parameters) {
        if (Commons.isEmpty(username)
                && Commons.isNotEmpty(password)) {
...
//    }
    ...
    public boolean isLocalHost() {
        return isLocalHost(host) || getParameter(Constants.LOCALHOST_KEY, false);
    }


    public static boolean isLocalHost(String host) {
        return host != null
                && (Constants.LOCAL_IP_PATTERN.matcher(host).matches()
    ...
    public URL addParameter(String key, String value) {
        if (Commons.isEmpty(key)
                || Commons.isEmpty(value)) {
            return this;
        }
    ...
    public URL addParameters(Map<String, String> parameters) {
        if (Commons.isEmptyMap(parameters)) {
            return this;
        }
    ...
    public URL addParameterString(String query) {
        ...
        return addParameters(Commons.parseQueryString(query));
    }
    ...
    public URL removeParameters(Collection<String> keys) {
        if (Commons.isEmptyCollection(keys)) {
            return this;
        }
    ...
    private void buildParameters(StringBuilder buf, boolean concat, String[] parameters) {
        if (Commons.isNotEmptyMap(getParameters())) {
            List<String> includes = (Commons.isEmptyArray(parameters) ? null : Arrays.asList(parameters));
            boolean first = true;
    ...
    private String buildString(boolean appendUser, boolean appendParameter, boolean useIP, boolean useService, String... parameters) {
        StringBuilder buf = new StringBuilder();
        if (Commons.isNotEmpty(protocol)) {
            buf.append(protocol);
            buf.append("://");
        }
        if (appendUser && Commons.isNotEmpty(username)) {
            buf.append(username);
    ...
    public String getPathKey() {
        String inf = Commons.isNotEmpty(path) ? path : getServiceInterface();
        if (inf == null) {
            return null;
        }
        return buildKey(inf, getParameter(Constants.GROUP_KEY), getParameter(Constants.VERSION_KEY));
...
//    }
    ...
    private static class Commons {
        ...
        static boolean isEmptyArray(final Object[] array) {
            return array == null || array.length == 0;
        }

        static boolean isNotEmptyArray(final Object[] array) {
        ...
        static boolean isNotEmptyCollection(Collection<?> collection) {
        ...
        static Map<String, String> toStringMap(String... pairs) {
        ...
        static final Pattern KVP_PATTERN = Pattern.compile("([_.a-zA-Z0-9][-_.a-zA-Z0-9]*)[=](.*)"); //key value pair pattern.
        ...
        static String getQueryStringValue(String qs, String key) {
            return parseQueryString(qs).get(key);
        }
    }
    ...
    private static class Constants {
        ...
        static final Pattern LOCAL_IP_PATTERN = Pattern.compile("127(\\.\\d{1,3}){3}$");
        static final String ANYHOST_VALUE = "0.0.0.0";
        static final String ANYHOST_KEY = "anyhost";

        static final String DEFAULT_KEY_PREFIX = "default.";
