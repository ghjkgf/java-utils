...
public final class ClassScanner {
     ...
     * @return
     */
    public static Set<Class<?>> getClasses(String scanPackage) throws IOException, ClassNotFoundException {
     ...
     * @return
     */
    public static Set<Class<?>> listAllSubclasses(String scanPackage, Class<?> parent) throws IOException, ClassNotFoundException {
    ...
    public static <A extends Annotation> Set<Class<?>> listClassesWithAnnotation(String scanPackage,
                                                                                 Class<A> annotation) throws IOException, ClassNotFoundException {
        return getClasses(scanPackage, (clazz) -> {
     ...
     * @return
     */
    public static Set<Class<?>> getClasses(String pack, Predicate<Class<?>> filter) throws IOException, ClassNotFoundException {
    ...
    private static Set<Class<?>> findClassFromJar(URL url, String packageName, String packageDirName, boolean recursive,
                                                  Predicate<Class<?>> filter) throws IOException, ClassNotFoundException {
        Set<Class<?>> result = new LinkedHashSet<Class<?>>();
        try {
            // 获取jar
    ...
    private static void findAndAddClassesInPackageByFile(String packageName, String packagePath,
                                                         final boolean recursive, Set<Class<?>> classes, Predicate<Class<?>> filter) throws ClassNotFoundException {
        // 获取此包的目录 建立一个File
